...
public class ShowClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO(DataSourceFactory.getDataSource()); //créer DAO avec sa source de données
        try (PrintWriter out = response.getWriter()) {//réponse générée par le navigateur 
